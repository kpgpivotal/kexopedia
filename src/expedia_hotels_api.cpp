...
vector<HotelRoom> HiltonHotelAPI::SearchRooms(string country, string city, string from_date, string to_date, int adults, int children, int needed_rooms) {
		...
		rooms.push_back( { "Hilton", "Interior View", 6, 200.0, "29-01-2022", "10-02-2022" });
		rooms.push_back( { "Hilton","City View", 3, 300.0, "29-01-2022", "10-02-2022" });
		rooms.push_back( { "Hilton","Deluxe View", 8, 500.0, "29-01-2022", "10-02-2022" });
...
vector<HotelRoom> MarriottHotelAPI::FindRooms(string from_date, string to_date, string country, string city, int needed_rooms, int adults, int children) {
		...
		rooms.push_back( { "Marriot", "City View", 8, 320.0, "29-01-2022", "10-02-2022" });
		rooms.push_back( { "Marriot","Interior View", 8, 220.0, "29-01-2022", "10-02-2022" });
		rooms.push_back( { "Marriot","Private View", 5, 600.0, "29-01-2022", "10-02-2022" });
